...
3. запускает выбранный API provider route или internal deterministic runner;
...
Документы по providers и routing:

- [Product CLI](docs/product-cli.ru.md)
- [Provider routes](docs/agent-adapters.ru.md)
...
`adapter-dry-run` example — compatibility fixture для AgentSpec routing; он не возвращает external AI CLI providers в product surface.
