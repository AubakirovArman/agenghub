...
Рабочий backlog находится в `prd/v2/`. Effect ledger foundation и rollback handler foundation сделаны. Следующая task — transaction resume, retry и resolve commands.
