...
|---|---|---|
| `0.4.113` | RC evidence dashboard/status polish | Done: `readiness completion/evidence/checklist` show named shell UX, Kimi, dogfood, latency, and approval gaps without reading raw JSONL |
| `0.4.114` | Daily shell/TUI regression hardening | Chat/Ops shell shortcuts, `/provider`, `!command`, event rail, and cost/status panels stay covered by no-bootstrap smoke and snapshot-style checks |
