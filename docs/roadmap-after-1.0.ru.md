...
| `0.4.120` | Kimi unblock and RC refresh | Run the replacement-key path when a valid Moonshot key is available, refresh live Kimi provider dogfood, collect RC evidence, and keep readiness blocked only on genuinely unresolved dogfood items |
