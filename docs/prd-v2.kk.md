...
Working backlog `prd/v2/` ішінде. Effect ledger foundation және rollback handler foundation done. Келесі task — transaction resume, retry және resolve commands.
