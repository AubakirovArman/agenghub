...
The working backlog is in `prd/v2/`. Effect ledger, rollback handlers, resume/retry/resolve, and Smart Sync are done. The next task is the Workspace Runtime trait.
