...
The working backlog is in `prd/v2/`. The effect ledger foundation and rollback handler foundation are done. The next task is transaction resume, retry, and resolve commands.
