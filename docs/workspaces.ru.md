...
Phase 11 доказывает, что один transaction manager может выполнять non-code tasks. AgentHub поддерживает git-worktree профили `code.git`, `content.git`, `data.git`, `infra.git`, `media.git`.
