...
工作 backlog 位于 `prd/v2/`。Effect ledger、rollback handlers、resume/retry/resolve、Smart Sync、Workspace Runtime trait、LLM Provider Gateway、VCM-OS typed memory、Hardened Runner、AAL v2 semantics 和 Adaptive Orchestration 已完成。下一项 task 是 Verifier Integrations v2。
