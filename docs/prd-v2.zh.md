...
工作 backlog 位于 `prd/v2/`。Effect ledger、rollback handlers、resume/retry/resolve、Smart Sync、Workspace Runtime trait、LLM Provider Gateway、VCM-OS typed memory、Hardened Runner 和 AAL v2 semantics 已完成。下一项 task 是 Adaptive Orchestration。
