...
AgentHub — не ещё один coding agent. Это локальный транзакционный runtime вокруг агентов: Codex, Gemini, Kimi, command-line tools и OpenAI-compatible endpoints.
