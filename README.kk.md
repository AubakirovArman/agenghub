...
1.0 readiness құжаттары: [Dogfooding](docs/dogfooding.kk.md), [Competitive Positioning](docs/competitive-positioning.kk.md), [Interactive Shell](docs/interactive-shell.kk.md)
