...
grep -q $'next\t4\tscripts/kimi-rc-unblock.sh' "$TMP/blocked.out"
grep -q $'next\t7\tAGENTHUB_PROVIDER_DOGFOOD_PROVIDER=kimi AGENTHUB_PROVIDER_DOGFOOD_LIVE=1 scripts/provider-dogfood.sh' "$TMP/blocked.out"
